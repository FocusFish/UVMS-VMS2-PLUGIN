...
public class ServiceMapper {
    ...
    public static ServiceType getServiceType(String serviceClassName, String displayName, String description, PluginType type, String responseMessageName) {
        ...
        serviceType.setName(displayName);
